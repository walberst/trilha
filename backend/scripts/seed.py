...
NOMES_ALUNOS = [
    "Ana Beatriz Souza", "Bruno Carvalho Lima", "Camila Ferreira Dias", "Daniel Alves Pereira",
    "Eduarda Martins Rocha", "Felipe Gomes Barbosa", "Gabriela Ribeiro Costa", "Henrique Nunes Cardoso",
    "Isabela Teixeira Moura", "Joao Vitor Correia", "Karina Duarte Pinto", "Lucas Mendes Azevedo",
    "Mariana Castro Freitas", "Nicolas Araujo Batista", "Olivia Ramos Siqueira", "Pedro Henrique Torres",
    "Quenia Farias Monteiro", "Rafael Cunha Xavier", "Sofia Vieira Andrade", "Thiago Peixoto Lopes",
    "Valentina Brito Cavalcante", "William Rezende Guimaraes", "Yasmin Tavares Nogueira", "Arthur Sales Cordeiro",
    "Beatriz Coelho Lacerda", "Caio Bezerra Marinho", "Debora Franco Salgado", "Enzo Pacheco Furtado",
    "Fernanda Melo Cavalcanti", "Gustavo Rocha Sampaio", "Helena Prado Barros", "Igor Cavalcanti Neves",
    "Julia Amaral Pimenta", "Kevin Moreira Sant'Anna", "Larissa Dantas Figueiredo", "Matheus Borges Vasconcelos",
]

CURSOS_SEED = [
    {
        "nome": "Python para Analise de Dados",
        "descricao": "Fundamentos de Python, pandas e visualizacao de dados para quem vem de negocios",
        "turmas": [
    ...
    try:
        ...
        for indice, matricula in enumerate(matriculas_criadas):
            ...
            for dias_atras, tipo in _gerar_eventos_perfil(perfil):
                timestamp_evento = agora - dt.timedelta(days=dias_atras, hours=random.randint(0, 20))
                evento = EventoComportamentoCriar(matricula_id=matricula.id, tipo=tipo, timestamp=timestamp_evento)
